...
class Featurizer:
    ...
    def __init__(self, tok2id={}, pad_id=0, lexicon_feature_bits=1):
        ...
        self.lexicons = {
            'assertives': self.read_lexicon('lib/lexicons/assertives_hooper1975.txt'),
            'entailed_arg': self.read_lexicon('lib/lexicons/entailed_arg_berant2012.txt'),
            'entailed': self.read_lexicon('lib/lexicons/entailed_berant2012.txt'), 
            'entailing_arg': self.read_lexicon('lib/lexicons/entailing_arg_berant2012.txt'), 
            'entailing': self.read_lexicon('lib/lexicons/entailing_berant2012.txt'), 
            'factives': self.read_lexicon('lib/lexicons/factives_hooper1975.txt'),
            'hedges': self.read_lexicon('lib/lexicons/hedges_hyland2005.txt'),
            'implicatives': self.read_lexicon('lib/lexicons/implicatives_karttunen1971.txt'),
            'negatives': self.read_lexicon('lib/lexicons/negative_liu2005.txt'),
            'positives': self.read_lexicon('lib/lexicons/positive_liu2005.txt'),
            'npov': self.read_lexicon('lib/lexicons/npov_lexicon.txt'),
            'reports': self.read_lexicon('lib/lexicons/report_verbs.txt'),
            'strong_subjectives': self.read_lexicon('lib/lexicons/strong_subjectives_riloff2003.txt'),
            'weak_subjectives': self.read_lexicon('lib/lexicons/weak_subjectives_riloff2003.txt')
        }
